...
public class ctl_property_info_int_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CtlLibraryPINVOKE.delete_ctl_property_info_int_t(swigCPtr);
        }
  ...
  public bool DefaultEnable {
    set {
      CtlLibraryPINVOKE.ctl_property_info_int_t_DefaultEnable_set(swigCPtr, value);
    } 
    get {
      bool ret = CtlLibraryPINVOKE.ctl_property_info_int_t_DefaultEnable_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_property_range_info_int_t RangeInfo {
    set {
      CtlLibraryPINVOKE.ctl_property_info_int_t_RangeInfo_set(swigCPtr, ctl_property_range_info_int_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = CtlLibraryPINVOKE.ctl_property_info_int_t_RangeInfo_get(swigCPtr);
      ctl_property_range_info_int_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new ctl_property_range_info_int_t(cPtr, false);
      return ret;
    } 
  }

  public ctl_property_info_int_t() : this(CtlLibraryPINVOKE.new_ctl_property_info_int_t(), true) {
  }
