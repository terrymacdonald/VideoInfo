...
public class ctl_adaptivesync_caps_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CtlLibraryPINVOKE.delete_ctl_adaptivesync_caps_t(swigCPtr);
        }
  ...
  public bool AdaptiveBalanceSupported {
    set {
      CtlLibraryPINVOKE.ctl_adaptivesync_caps_t_AdaptiveBalanceSupported_set(swigCPtr, value);
    } 
    get {
      bool ret = CtlLibraryPINVOKE.ctl_adaptivesync_caps_t_AdaptiveBalanceSupported_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_property_info_float_t AdaptiveBalanceStrengthCaps {
    set {
      CtlLibraryPINVOKE.ctl_adaptivesync_caps_t_AdaptiveBalanceStrengthCaps_set(swigCPtr, ctl_property_info_float_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = CtlLibraryPINVOKE.ctl_adaptivesync_caps_t_AdaptiveBalanceStrengthCaps_get(swigCPtr);
      ctl_property_info_float_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new ctl_property_info_float_t(cPtr, false);
      return ret;
    } 
  }

  public ctl_adaptivesync_caps_t() : this(CtlLibraryPINVOKE.new_ctl_adaptivesync_caps_t(), true) {
  }
