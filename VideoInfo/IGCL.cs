...
{
    // This code was based upon initial code developed by Lesueur Benjamin (@Valkirie) for their HandlheldCompanion application
    // (https://github.com/Valkirie/HandheldCompanion) and was extended using code and examples from the Intel Graphics Command Line Interface (IGCL) API documentation and headers.
    // This code has been modified and extended to support additional features and functionality required by DisplayMagician.
    ...
    public class IGCLImport
    {
        ...
        [DllImport(dllKernelName)]
        public static extern IntPtr LoadLibrary(string lpFileName);

        [DllImport(dllKernelName, SetLastError = true)]
        ...
        public static int GetDevices(out List<ctl_device_adapter_properties_t> adapters)
        {
            ctl_result_t Result = ctl_result_t.CTL_RESULT_SUCCESS;
            uint adapterCount = 0;
            adapters = new List<ctl_device_adapter_properties_t>();
            ...
            for (int idx = 0; idx < devices.Length; idx++)
            {
                ...
                adapters.Add(StDeviceAdapterProperties);
            }
