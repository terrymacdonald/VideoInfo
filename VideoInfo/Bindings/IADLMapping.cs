...
public class IADLMapping : global::System.IDisposable {
  ...
  public virtual ADLX_RESULT ADLIdsFromADLXDesktop(IADLXDesktop pDesktop, SWIGTYPE_p_int adapterIndex, SWIGTYPE_p_int VidPnSourceId, SWIGTYPE_p_int bus, SWIGTYPE_p_int device, SWIGTYPE_p_int function) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLMapping_ADLIdsFromADLXDesktop(swigCPtr, IADLXDesktop.getCPtr(pDesktop), SWIGTYPE_p_int.getCPtr(adapterIndex), SWIGTYPE_p_int.getCPtr(VidPnSourceId), SWIGTYPE_p_int.getCPtr(bus), SWIGTYPE_p_int.getCPtr(device), SWIGTYPE_p_int.getCPtr(function));
    return ret;
  }
