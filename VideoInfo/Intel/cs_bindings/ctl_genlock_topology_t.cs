...
public class ctl_genlock_topology_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_genlock_topology_t(swigCPtr);
        }
  ...
  public byte NumGenlockDisplays {
    ...
    get {
      byte ret = IGCLPINVOKE.ctl_genlock_topology_t_NumGenlockDisplays_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public bool IsPrimaryGenlockSystem {
    set {
      IGCLPINVOKE.ctl_genlock_topology_t_IsPrimaryGenlockSystem_set(swigCPtr, value);
    } 
    get {
      bool ret = IGCLPINVOKE.ctl_genlock_topology_t_IsPrimaryGenlockSystem_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_genlock_topology_t() : this(IGCLPINVOKE.new_ctl_genlock_topology_t(), true) {
  }
