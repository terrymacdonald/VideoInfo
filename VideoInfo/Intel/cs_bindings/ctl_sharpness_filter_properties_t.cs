...
public class ctl_sharpness_filter_properties_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_sharpness_filter_properties_t(swigCPtr);
        }
  ...
  public uint FilterType {
    ...
    get {
      uint ret = IGCLPINVOKE.ctl_sharpness_filter_properties_t_FilterType_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_sharpness_filter_properties_t() : this(IGCLPINVOKE.new_ctl_sharpness_filter_properties_t(), true) {
  }
