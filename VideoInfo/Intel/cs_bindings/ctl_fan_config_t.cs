...
public class ctl_fan_config_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_fan_config_t(swigCPtr);
        }
  ...
  public uint Size {
    ...
    get {
      uint ret = IGCLPINVOKE.ctl_fan_config_t_Size_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public byte Version {
    set {
      IGCLPINVOKE.ctl_fan_config_t_Version_set(swigCPtr, value);
    } 
    get {
      byte ret = IGCLPINVOKE.ctl_fan_config_t_Version_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_fan_speed_mode_t mode {
    set {
      IGCLPINVOKE.ctl_fan_config_t_mode_set(swigCPtr, (int)value);
    } 
    get {
      ctl_fan_speed_mode_t ret = (ctl_fan_speed_mode_t)IGCLPINVOKE.ctl_fan_config_t_mode_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_fan_config_t() : this(IGCLPINVOKE.new_ctl_fan_config_t(), true) {
  }
