...
public class ctl_power_optimization_feature_specific_info_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_power_optimization_feature_specific_info_t(swigCPtr);
        }
  ...
  public ctl_power_optimization_feature_specific_info_t() : this(IGCLPINVOKE.new_ctl_power_optimization_feature_specific_info_t(), true) {
  }
