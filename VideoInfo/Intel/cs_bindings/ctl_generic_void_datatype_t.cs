...
public class ctl_generic_void_datatype_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_generic_void_datatype_t(swigCPtr);
        }
  ...
  public uint size {
    set {
      IGCLPINVOKE.ctl_generic_void_datatype_t_size_set(swigCPtr, value);
    } 
    get {
      uint ret = IGCLPINVOKE.ctl_generic_void_datatype_t_size_get(swigCPtr);
      return ret;
    } 
  }

  public ctl_generic_void_datatype_t() : this(IGCLPINVOKE.new_ctl_generic_void_datatype_t(), true) {
  }
