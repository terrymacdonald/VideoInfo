...
public class ctl_pixtx_pipe_get_config_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_pixtx_pipe_get_config_t(swigCPtr);
        }
  ...
  public uint Size {
    ...
    get {
      uint ret = IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_Size_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public byte Version {
    set {
      IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_Version_set(swigCPtr, value);
    } 
    get {
      byte ret = IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_Version_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_pixtx_config_query_type_t QueryType {
    set {
      IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_QueryType_set(swigCPtr, (int)value);
    } 
    get {
      ctl_pixtx_config_query_type_t ret = (ctl_pixtx_config_query_type_t)IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_QueryType_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public uint NumBlocks {
    set {
      IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_NumBlocks_set(swigCPtr, value);
    } 
    get {
      uint ret = IGCLPINVOKE.ctl_pixtx_pipe_get_config_t_NumBlocks_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_pixtx_pipe_get_config_t() : this(IGCLPINVOKE.new_ctl_pixtx_pipe_get_config_t(), true) {
  }
