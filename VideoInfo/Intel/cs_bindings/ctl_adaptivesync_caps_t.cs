...
public class ctl_adaptivesync_caps_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_adaptivesync_caps_t(swigCPtr);
        }
  ...
  public bool AdaptiveBalanceSupported {
    ...
    get {
      bool ret = IGCLPINVOKE.ctl_adaptivesync_caps_t_AdaptiveBalanceSupported_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public ctl_adaptivesync_caps_t() : this(IGCLPINVOKE.new_ctl_adaptivesync_caps_t(), true) {
  }
