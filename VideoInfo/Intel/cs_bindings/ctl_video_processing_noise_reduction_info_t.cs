...
public class ctl_video_processing_noise_reduction_info_t : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IGCLPINVOKE.delete_ctl_video_processing_noise_reduction_info_t(swigCPtr);
        }
  ...
  public uint Size {
    ...
    get {
      uint ret = IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_Size_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public byte Version {
    set {
      IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_Version_set(swigCPtr, value);
    } 
    get {
      byte ret = IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_Version_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public bool noise_reduction_auto_detect_supported {
    set {
      IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_noise_reduction_auto_detect_supported_set(swigCPtr, value);
    } 
    get {
      bool ret = IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_noise_reduction_auto_detect_supported_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_unsigned_int ReservedFields {
    set {
      IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_ReservedFields_set(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = IGCLPINVOKE.ctl_video_processing_noise_reduction_info_t_ReservedFields_get(swigCPtr);
      SWIGTYPE_p_unsigned_int ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_unsigned_int(cPtr, false);
      return ret;
    } 
  }

  public ctl_video_processing_noise_reduction_info_t() : this(IGCLPINVOKE.new_ctl_video_processing_noise_reduction_info_t(), true) {
  }
